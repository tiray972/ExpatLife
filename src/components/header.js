    ...
    <header className="bg-white text-black shadow-md">
      <div className="container mx-auto px-4 flex items-center justify-between py-4">
        ...
        <nav className="hidden md:flex space-x-6">
          ...
          <Link href={`/${lang}/accompagnement`} className="hover:text-teal-200">Visa & business</Link>
      ...
      {menuOpen && (
        <nav className="md:hidden bg-white shadow-lg">
          <ul className="flex flex-col items-start space-y-4 px-4 py-6">
            ...
            <li><Link href={`/${lang}/accompagnement`} className="hover:text-teal-200">Visa & business</Link></li>
